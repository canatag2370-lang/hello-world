...
class AgeGenderEstimator:
    ...
    def _ensure_model(self) -> None:
        ...
        if sys.version_info >= (3, 12):
            self._log_warning(
                "DeepFace şu anda Python 3.12 ve üzerini desteklemiyor. Lütfen"
                " Python 3.10 veya 3.11 gibi desteklenen bir sürüm kullanın"
                " ya da DeepFace'i bu ortamda manuel olarak kurabileceğiniz"
                " yeni bir sürüm yayınlanana kadar demografik tahminleri"
                " devre dışı bırakın."
            )
